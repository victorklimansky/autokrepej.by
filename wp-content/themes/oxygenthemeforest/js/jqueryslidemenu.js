...
$(function(){
	var arrowimages={down:['downarrowclass', 'down.gif', 10], right:['rightarrowclass', 'right.gif']}
	...
	jqueryslidemenu.buildmenu("menu1", arrowimages);
	jqueryslidemenu.buildmenu("menu2", arrowimages);
	jqueryslidemenu.buildmenu("menu3", arrowimages);
	jqueryslidemenu.buildmenu("menu4", arrowimages);
});