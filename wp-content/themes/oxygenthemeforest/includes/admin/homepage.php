											...
											<td colspan="2">
												...
												<div>
													<div class="label"><span>Img URL:</span>
														...
														<?php echo orange_themes_info_message("Suggested image size is 48x48px");?>
													</div>
														<div class="setting">
															...
															<script type="text/javascript">
																jQuery(document).ready(function($){ orangethemes.loadUploader(jQuery("div#ib1_image_button"), "<?php echo THEME_FUNCTIONS_URL;?>upload-handler.php", "<?php echo THEME_UPLOADS_URL;?>");});
															</script>	
														</div>
												</div>
											...
											<td colspan="2">
												...
												<div>
													...
													<div class="setting">
														...
														<script type="text/javascript">
															jQuery(document).ready(function($){ orangethemes.loadUploader(jQuery("div#ib2_image_button"), "<?php echo THEME_FUNCTIONS_URL;?>upload-handler.php", "<?php echo THEME_UPLOADS_URL;?>");});
														</script>	
													</div>
												</div>
											...
											<td colspan="2">
												...
												<div>
													...
													<div class="setting">
														...
														<script type="text/javascript">
															jQuery(document).ready(function($){ orangethemes.loadUploader(jQuery("div#ib3_image_button"), "<?php echo THEME_FUNCTIONS_URL;?>upload-handler.php", "<?php echo THEME_UPLOADS_URL;?>");});
														</script>	
													</div>
												</div>
											...
											<td colspan="2">
												...
												<div>
													...
													<div class="setting">
														...
														<script type="text/javascript">
															jQuery(document).ready(function($){ orangethemes.loadUploader(jQuery("div#ib4_image_button"), "<?php echo THEME_FUNCTIONS_URL;?>upload-handler.php", "<?php echo THEME_UPLOADS_URL;?>");});
														</script>	
													</div>
												</div>
