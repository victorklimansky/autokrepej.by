...
define( 'NOTIFIER_XML_FILE', 'http://www.orange-themes.com/'.THEME_NAME.'/notifier/' ); // The remote notifier XML file containing the latest version of the theme and changelog
...
function get_latest_theme_version($interval) {
	...
	$db_cache_field = 'orange-'.THEME_NAME.'-notifier-cache';
	$db_cache_field_last_updated = 'orange-'.THEME_NAME.'-notifier-cache-last-updated';
