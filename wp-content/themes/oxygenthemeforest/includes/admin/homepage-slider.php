											...
											<td colspan="2">
												...
												<div>
													...
													<div class="setting">
														...
														<script type="text/javascript">
															jQuery(document).ready(function($){ orangethemes.loadUploader(jQuery("div#homepage_image_button"), "<?php echo THEME_FUNCTIONS_URL;?>upload-handler.php", "<?php echo THEME_UPLOADS_URL;?>");});
														</script>														</div>
												</div>
												<?php } ?>
											</td>
