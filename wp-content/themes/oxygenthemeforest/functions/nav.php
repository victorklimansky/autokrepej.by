...
"><i>&nbsp;</i><b><span><?php printf(__('Previous posts','oxygen')); ?></span></b><u>&nbsp;</u></a>

			<a class="btn-1 btn-align-right btn-next<?php if($page_num == 1) echo "-disabled"; ?>" href="<?php if ($page_num > 1) { $new_page = $page_num - 1;} else {$new_page = 1;} echo custom_nav_btn_links($search, $new_page); ?>"><i>&nbsp;</i><b><span><?php printf(__('Next posts','oxygen')); ?></span></b><u>&nbsp;</u></a>
		</div>
		<?php
	}
}
	...
	if($max_num_pages > 1 ){
		?>
			<table>
				<tr>
					<td> 
						<a class="prev" href="<?php if ($page_num > 1) { $new_page = $page_num - 1;} else {$new_page = 1;} echo custom_nav_btn_links($search, $new_page); ?>">&laquo; <?php printf(__('Previous','oxygen')); ?></a>
						<?php
						...
						?>
						<a class="next" href="<?php if ($page_num < $max_num_pages) {$new_page = $page_num + 1;} else {$new_page = $page_num;} echo custom_nav_btn_links($search, $new_page);?>"><?php printf(__('Next','oxygen')); ?> &raquo;</a>
					</td>
				</tr>
			</table>
		<?php
